...
namespace Controller.Controllers
{
	...
	public class CrawlerController : Controller {
		...
		protected virtual void CheckSurfaces(Vector3 velocity)
		{
			var pos = tr.position;
			var origin = pos + velocity.normalized * 0.5f;
			Debug.DrawLine(pos, origin, Color.yellow);
			//Physics.Raycast()
		}
